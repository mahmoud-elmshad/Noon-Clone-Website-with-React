    ...
    <div class="row my-4">
      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0 ">
        <div class="listgroup ">
          ...
          <a href="" class="listgroupitem ">Mobiles New Arrival</a>
          <a href="" class="listgroupitem ">All Mobile Phones</a>
          <a href="" class="listgroupitem">All Tablets</a>
          <a href="" class="listgroupitem">Video Games</a>
          <a href="" class="listgroupitem ">Smart Watches & Accessories</a>
          <a href="" class="listgroupitem ">Wirless Earphones</a>
          <a href="" class="listgroupitem ">Earphones</a>
          <a href="" class="listgroupitem ">Chargers & Cables</a>
          <a href="" class="listgroupitem ">Selfie Stick & Holders</a>
          <a href="" class="listgroupitem ">Covers & ScreenProtectors</a>
          <a href="" class="listgroupitem ">Mobile Gaming & VR Gadget</a>
          <a href="" class="listgroupitem ">Micro SD Cards</a>

        </div>
      </div>
      
      <div class="col-md-6 col-lg-4 mb-3 mb-lg-0 mx-0 px-0">
        <div class="row">
      ...
      <div class="col-md-6 col-lg-3 mb-3 mb-md-0  mx-0 px-0">
      ...
      <div class="col-md-4 col-lg-2 mb-3 mb-md-0  mx-0 px-0">
        <div class="list-group list-group-flush">
          <a href="" class="games">
