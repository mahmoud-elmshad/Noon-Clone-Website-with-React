    ...
    <Container className="mb-5">
        ...
        <Col sm={4}>
          ...
          <div className="my-1">
            <span style={{ fontSize: "0.8em" }}>
              ...
              <span style={{ background: "#38AE04", color: "white" }}>
                {" "}
                4.8{" "}
                <img
                  alt="starFilled"
          ...
          >
            <img
              ...
              alt=""
            />
            <span>Monthly payment plans from EGP 384 </span>
            <span>
      ...
      <div className="tab-content my-5" id="pills-tabContent">
        ...
        >
          ...
          <ul>
            <li>
              Crafted Elegantly, It Lend The Perfect Touch Of Fashion Vibe To
              Your Overall Look
            </li>
            <li>Designed To Accentuate Your Style Statement</li>
            <li>Ideal For Regular Use</li>
          </ul>
          <div className="Container fw-bold my-2">Overview</div>
          <div>
            Founded in 2003, DEFACTO is today one of the most popular fashion
            brands in Turkey and around the world with more than 500 stores. It
            is positioned as a pioneering brand of fashion throughout the
            Mediterranean world
          </div>
        </div>
        <div
