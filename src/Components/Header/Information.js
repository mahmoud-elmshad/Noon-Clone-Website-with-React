      ...
      {profilename ? (
        ...
        <div className=" w-75 mx-auto vh-100">
          <form className=" mx-auto my-3" onSubmit={handleInfo}>
            ...
            <div
              class="form-outline  w-25 w-sm-25 mb-4"
              style={{ maxWidth: "300px", minWidth: "300px" }}
            >
            ...
            <div className="d-flex flex-md-row flex-column gap-3 justify-content-sm-start w-75">
              <div
                class="form-outline flex-fill  w-25 my-3"
                style={{ maxWidth: "300px", minWidth: "300px" }}
              >
