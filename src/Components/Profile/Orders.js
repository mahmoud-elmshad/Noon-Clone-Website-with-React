  ...
  return (
    <>
      <div className='container-fluid mt-5'>
        ...
        <div style={{ opacity: '70%' }}>View your order history and check the delivery status for items</div>
      </div>
      {allPrdList.length > 0 ?
        <div>
            ...
            return (
              <>
                <div className='container-fluid'>
                  <div className='row my-2 py-3' style={{ height: '10em', backgroundColor: "white", border: '1px solid lightgrey' }}>

                    <div className='col-3 d-flex justify-content-around flex-column' style={{ borderRight: '1px solid rgb(240, 242, 248)', height: '100%' }}>
                      <div style={{ textTransform: 'uppercase' }}>{user.uid}</div>
                      <div style={{ opacity: '70%' }}>Placed on 29 Nov 2020</div>
                      <div className='orders' style={{ width: 'fit-content' }}>Delivered</div>
                    </div>
                    <div className='col-9'>
                      <div>
                        <div className='d-flex align-items-center'>
                          ...
                          <div style={{ display: '-webkit-box', WebkitLineClamp: '2', overflow: 'hidden', textOverflow: 'ellipsis', WebkitBoxOrient: 'vertical' }}>
                            {value.description}
                          </div>
                        </div>
                      </div>
